...
import com.bugcatcher.exception.StorageException;
import com.bugcatcher.exception.StorageFileNotFoundException;

@Service("BugcatcherFileSystemStorageService")
public class FileSystemStorageService implements StorageService {
	...
	public void store(MultipartFile file, String newFileName) {
		//String newFileName = new SimpleDateFormat("yyyyMMddHHmm").format(new Date()) + "." + file.getOriginalFilename();
